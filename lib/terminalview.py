...
class TerminalView():
    ...
    def config_draw(self):
        ...
        print(self.t.move(3,4) + self.t.white_on_black(self.t.bold('URL: ')) + self.t.slategray3(self.t.bold(self.cryptomg.url)))
    ...
    def status_draw(self):
        ...
        print(self.t.move(13,4) + self.t.white_on_black(self.t.bold('Current Block: ')) + self.t.slategray3(self.t.bold(current_block_text)))
        print(self.t.move(14,4) + self.t.white_on_black(self.t.bold('Current Position: ')) + self.t.slategray3(self.t.bold(str(self.cryptomg.current_pos))))
    ...
    def detector_byte_draw(self):
        print(self.t.move(23 + self.possible_values_size,4) + self.t.white_on_black(self.t.bold('Detector Bytes: ')) + self.t.slategray3(self.t.bold(self.cryptomg.detector_byte)))


    def last_request_draw(self):
        print(self.t.move(24 + self.possible_values_size,4) + self.t.white_on_black(self.t.bold('Last Request: ')) + self.t.slategray3(self.t.bold(self.cryptomg.last_request)))
    ...
    def exploit_url_draw(self):
        ...
        if ((self.cryptomg.handler == "SP" and self.cryptomg.findKeyComplete == True) or (self.cryptomg.handler == "DH" and self.cryptomg.exploit_url != '')):
            ...
            if self.cryptomg.handler == "SP":
                ...
                print(self.t.move(39,int(self.t.width / 2) +5) + self.t.white_on_black(self.t.bold('Exploit URL:')) + self.t.red_on_black(self.t.bold(' SpellCheckHandler Endpoint can only be used to retrieve key')))
    ...
    def initial_draw(self):
       ...
       # header
        print(self.t.move(0, 0) + self.t.white_on_green(self.t.center(self.t.bold('dp_cryptOMG.py 0.1 - Telerik DialogHandler Weak Crypto Exploit (CVE-2017-9248) - @paulmmueller'))))
        ...
        # bottom
        print(self.t.move(4 + log_box_size,int(self.t.width / 2) +5) + self.t.white(("█" * (int(self.t.width / 2)-14))))
